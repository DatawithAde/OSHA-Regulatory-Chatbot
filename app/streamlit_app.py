...
# ── Page config ──────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="OSHA 1910 Regulatory Chatbot",
    page_icon="🦺",
    layout="wide"
)
...
st.markdown("**29 CFR Part 1910 — General Industry Standards**")
st.markdown("Ask any compliance question and get answers with exact CFR citations.")
st.divider()
...
with st.sidebar:
    ...
    **Framework:** LangChain  
    ...
    examples = [
        ...
        "What are the fire extinguisher inspection requirements?",
        "What are the requirements for emergency eyewash stations?",
    ]
    for ex in examples:
